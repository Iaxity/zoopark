<template>
  <div class="animals">
    <div class="animals__filter">
      <h2>Filter_1</h2>
      <input type="search" class="animals__search" />
      <h2>Filter_2</h2>
      <input type="search" class="animals__search" />
      <h2>Filter_3</h2>
      <input type="search" class="animals__search" />
  ...
  />
  <EditAnimal v-show="shownEditAnimal" @close="shownEditAnimal = false" />
</template>

<script setup>
import { ref } from "vue";
import DeleteEntryAnimal from "./DeleteEntryAnimal.vue";
